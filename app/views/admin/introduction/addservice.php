...
<body>
    ...
    <div id="app">
        ...
        <div id="main">
            ...
            <form action="" class="page-heading" method="post" onsubmit="return addConfirm()"
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="form-group mb-3">
                                        <label for="preview" class="form-label">Title</label>
                ...
                <input type="submit" name="addservice" class="btn btn-primary" role="button" value="Add this service">
    ...
    function addConfirm() {
        ...
        return confirm("Add this service?"); 
    }
    </script>
    </script> 
</body>
