...
<body>
    ...
    <div id="app">
        ...
        <div id="main">
            ...
            <form class="page-heading" method="post" onsubmit="return updateConfirm()" enctype="multipart/form-data">
                                ...
                                <div class="card-body">
                                    <div class="form-group mb-3">
                                        ...
                                        <textarea class="form-control tinymce" id="content" name="content"
                                            rows="30"><?php echo $row["Content"] ?></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="form-check">
                                        <div class="checkbox">
                                            <input type="checkbox" class="form-check-input" id="isPublic"
                                                name="isPublic" value="yes"
                                                <?php echo $row["IsPublic"] == "yes" ? "checked" : "" ?>>
                ...
                <input type="submit" name="update" class="btn btn-success" role="button" value="Update this blog">
    ...
    <!-- đảm bảo content không được để trống trc khi submit -->
    <script>
    function updateConfirm() {
        ...
        return confirm("Update this blog?");
    }
    </script>
