...
<body>
            ...
            <div class="page-heading">
                ...
                <section class="section">
                    ...
                    <table class="table table-striped table-bordered" id="table1">
                        <thead>
                            <tr>
                                <?php echo $tableFAQHeader; ?>
                            </tr>
                        </thead>
                        <tbody>
                            <?php echo $tableFAQBody ?>
                        </tbody>
                    </table>
                </section>
            </div>
    ...
    function deleteConfirm(id) {
        if (confirm(`Delete this faq with ID =  ${id}?`)) {
            window.location.href = `/webprogramming_assignment_242/admin/faq/deletefaq?id=${id}`;
        }
    }
    </script>
</body>
