...
<body>
    ...
    <div id="app">
        ...
        <div id="main">
            ...
            <form class="page-heading" method="post" onsubmit="return updateConfirm()">
                <div class="page-title">
                    <div class="row">
                        <div class="col-12 col-md-6 order-md-1 order-last">
                            <h3>Update this user's login status</h3>
                        </div>
                    </div>
                </div>
                <section class="section">
                    <div class="row">
                        <div class="col">
                            <div class="card">
                                <div class="card-body">
                                    <div class="form-label">Lock this user's login status?</div>
                                    <div class="form-check">
                                        <div class="checkbox">
                                            <input type="checkbox" class="form-check-input" id="isLocked"
                                                name="isLocked" value="yes"
                                                <?php echo $row["loginAttempts"] == 5 ? "checked" : "" ?>>
                ...
                <input type="submit" name="update" class="btn btn-success" role="button"
                    value="Update this user's login status">
    ...
    function updateConfirm() {
        return confirm("Update this user's login status?");
    }
    </script>
