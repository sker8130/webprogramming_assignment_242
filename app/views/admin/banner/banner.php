    ...
    if ($check !== false) {
        ...
        if (in_array($fileType, $allowTypes)) {
            ...
            if (move_uploaded_file($_FILES["banner"]["tmp_name"], $targetFilePath)) {
                ...
                if ($BannerModel->updateLogo($targetFilePath)) {
                    $_SESSION["success_message"] = "Banner has been updated successfully.";
                } else {
                    $_SESSION["error_message"] = "Failed to update banner in database.";
                }
            } else {
                $_SESSION["error_message"] = "Failed to upload banner to server.";
            }
        } else {
...
$currentLogo = $BannerModel->getLogo();
                ...
                <div class="page-title">
                    <div class="row">
                        <div class="col-12 col-md-6 order-md-1 order-last">
                            ...
                            <p class="text-subtitle text-muted">Update Banner</p>
                        </div>
                ...
                <section class="section">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Current Banner</h4>
                        </div>
                        <div class="card-body">
                            <div class="row">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Upload New Banner</h4>
                        </div>
                        <div class="card-body">
                            <form action="" method="POST" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            <label for="banner">Select Banner Image</label>
                                ...
                                <div class="col-12 d-flex justify-content-end">
                                    <button type="submit" class="btn btn-primary me-1 mb-1">Upload Banner</button>
                                </div>
                            </form>
                        </div>
                    </div>
