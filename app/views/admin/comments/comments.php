                            ...
                            <form method="post" class="row">
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        <label for="usernameForComments">Username Input</label>
                                        <input type="text" id="usernameForComments" name="usernameForComments"
                                            class="form-control round" placeholder="Enter username"
                                            value="<?php echo isset($oldInput["usernameForComments"]) ? htmlspecialchars($oldInput["usernameForComments"]) : ""; ?>">
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        <label for="blogIDForComments">BlogID Input</label>
                                        <input type="number" id="blogIDForComments" name="blogIDForComments"
                                            class="form-control round" placeholder="Enter blog id"
                                            value="<?php echo isset($oldInput["blogIDForComments"]) ? htmlspecialchars($oldInput["blogIDForComments"]) : ""; ?>">
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        <label for="contentForComments">Content Input</label>
                                        <input type="text" id="contentForComments" name="contentForComments"
                                            class="form-control round" placeholder="Enter comment's content"
                                            value="<?php echo isset($oldInput["contentForComments"]) ? htmlspecialchars($oldInput["contentForComments"]) : ""; ?>">
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                    <div class="form-group mt-4"><input type="submit" value="Search"
                                            name="searchForComments" class="btn btn-success">
                                    </div>
                                </div>
