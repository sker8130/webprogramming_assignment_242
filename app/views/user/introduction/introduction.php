                    ...
                    <div class="carousel-item <?php if ($firstBranch) echo 'active'; ?>">
                        <div class="carousel-card">
                            ...
                            <div class="carousel-image">
                                <img src="<?php echo htmlspecialchars($branch['image']); ?>" alt="<?php echo htmlspecialchars($branch['location']); ?>">
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="card-content">
                                        ...
                                        <?php if (isset($_SESSION['mySession']) && ($_SESSION['mySession'] == 'admin' || $_SESSION['mySession'] == 'admin@gmail.com')): ?>
                                            <div class="button-container">
                                                <a href="/admin/members/edit/<?php echo htmlspecialchars($member['ID']); ?>" class="btn btn-primary" style="margin-right: 7.5px;">Sửa</a>
                                                <a href="/admin/members/delete/<?php echo htmlspecialchars($member['ID']); ?>" class="btn btn-danger" style="margin-right: 7.5px;">Xóa</a>
                                            </div>
                                        <?php endif; ?>
                                    </div>
                                </div>
